...
def print_help():
    ...
    help_data = [
        ...
        (COMMANDS['change_contact'], "<name> <phone> <old_phone> <new_value",
         "Change phone number for the existing contact."),
        (COMMANDS['change_contact'], "<name> <field> <new_value>",
         "Change field: address (multi-words), birthday, or email for the existing contact."),
        (COMMANDS['delete_contact'], "<name>", "Delete existing contact."),
        (COMMANDS['show_contact'], "<name>","or", "<email>"
         "Show the full contact information."),
